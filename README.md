# Project Grendel — A JP4 Fan WebNovel
...
**There is no `LICENSE` file in this repo, and that is intentional.**

I cannot grant an open-source license on this work. The underlying intellectual property (the *Jurassic Park* franchise, the John Sayles screenplay concepts) is owned by Universal Pictures and the original creators, not by me. I have no right to permit anyone to fork, redistribute, or sell this prose.

This repo exists as a public, non-commercial fan-art project — visible on GitHub for other JP fans to read. That is the only purpose. **All rights to the underlying IP belong to their respective owners.** No commercial use of this prose is permitted, and no derivative works are licensed by me.

If you are a representative of a rights-holder and want this taken down, please open an issue or contact the maintainer and the repository will be removed.

## What's NOT in this repo

- The original John Sayles screenplay PDF
- Any direct screenplay excerpts beyond what's necessary for fair-use commentary
- Promotional images or franchise art
...
*Project Grendel is a labor of love for fans of the unmade Sayles draft. Read, share, and if you ever get the chance — buy the official films.*
